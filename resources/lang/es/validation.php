...
return [
    ...
    */
    ...
    'after_or_equal'       => 'El campo fecha de finalización debe ser una fecha posterior o igual a la fecha de inicial.',
    ...
    */
    ...
    'attributes' => [
        ...
        'closing_time' => 'hora de finalización',
        'code' => 'código',
        'name' => 'nombre',
        ...
        'status_id' => 'estado',
        'session_id' => 'sesión',
        'user_role_group_id' => 'grupo',
        'subarea_id' => 'subárea',
        'area_id' => 'área',
        'origin_id' => 'plan de formación',
        ...
        'course_id' => 'curso',
        'module_id' => 'modulo',
        'sectional_council_id' => 'concejo seccional',
        'entities' => 'entidades',
        'specialtym_id' => 'especialidad',
        'role_id' => 'rol',
        'region_id' => 'departamento',
        'circuit_id' => 'circuito',
        'user_role_category_inscription_id' => '',
        'group_id' => 'grupo',
        'user_role_id' => 'rol de usuario',
        'password' => 'contraseña',
        ...
        'answer_id' => 'respuesta',
        'image_question_type' => 'imagen de pregunta',
        'survey_id' => 'encuesta',
        'section_id' => 'sección',
        'weight' => 'peso',
        'is_percent' => 'porcentaje',
        'question_type_id' => 'tipo de pregunta',
        'duration' => 'duración',
        'survey_type_id' => 'tipo de encuesta',
        'url_image' => 'imagen',
        'max_points' => 'puntaje máximo',
        'objetives' => 'objetivos',
        'dt_init' => 'disponible desde',
        'dt_finish' => 'disponible hasta',
