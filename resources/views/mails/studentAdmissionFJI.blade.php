                  ...
                  <td> 
                    <div class="contentEditableContainer contentTextEditable"> 
                      <div class="contentEditable" style="text-align: justify;">
                          ...
                          <br /> 
                          <p style="color:#263238;">Usted ha sido registrado satisfactoriamente a la plataforma de la Escuela Judicial Rodrigo Lara Bonilla.</p>
                          <br/>
                          <p style="color:#263238;">Su usuario esta identificado con la siguiente información:</p>
                        <br/>
						...
						<br/>
						<p style="color:#263238;">Recuerde que esta clave la puede cambiar en el panel de usuario.</p>
						<br/>
						<p style="color:#263238;">Para ingresar al sistema por favor utilice la siguiente dirección electrónica <a href="http://www.ejrlb.net/" target="_blank">http://www.ejrlb.net/</a>, botón "Inscripción y Registro".</p>
						<br/>
						<p style="color:#263238;">Señor usuario, es indispensable que inicie sesión con su usuario y contraseña asignado. Seleccione del menú la opcion "Formación Judicial Inicial" y de clic sobre el botón "Información", con el fin de continuar el proceso de registro complementando los datos básicos, datos específicos y adjuntar la documentación necesaria para el ingreso al curso de formación.</p> 
                          <br /> 
                          <br /> 
                          <br /> 
                    </div>
