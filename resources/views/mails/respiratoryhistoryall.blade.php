            ...
            <p style="margin-top:0pt; margin-bottom:0pt; line-height:6%; widows:0; orphans:0; font-size:10pt">
                ...
                <span style="height:0pt; display:block; position:absolute; z-index:-65543">
                    <div style="float:right;">
                        ...
                        <p>Fecha de registro: {{ (new DateTime($tr['created_at']))->setTimezone(new DateTimeZone('America/Bogota'))->format('Y-m-d H:i:s') }}</p>
                    ...
                    <div style="text-align: center;    margin-left: 60px;">
                        ...
                        <p style="font-size:9px">{{$tr["admissions"]["campus"]["address"]}}, {{$tr["admissions"]["campus"]["region"]["name"]}}, {{$tr["admissions"]["campus"]["name"]}}</p>
                        <p>Nit: 900900122 - 7</p>
                    </div>
