								...
								<tr>
									<td>
										<div class="contentEditableContainer contentTextEditable">
											<div class="contentEditable" style="text-align: center;">
												<br />
												<p>Estimado(a) coordinador, administrador ó auxiliar de logistica,</p>
												<br />
												<p>El cierre del evento detectó que existen horas no registradas en las planillas de asistencia del curso {{ $name }}.</p>
												<br/>
												<p>Para ingresar al sistema por favor utilice la dirección electrónica http://ejrlb.net</p>
												<br />
												<br />
												<br />
