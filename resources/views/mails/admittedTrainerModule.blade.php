...
<html xmlns="http://www.w3.org/1999/xhtml"> 
  <head> 
    ...
    <style type="text/css"> 
      ...
      .contentEditable h2.big,.contentEditable h1.big{  font-size: 26px !important;} .contentEditable h2.bigger,.contentEditable h1.bigger{  font-size: 37px !important;}td,table{  vertical-align: top;}td.middle{  vertical-align: middle;}a.link1{  font-size:13px;  color:#27A1E5;  line-height: 24px;  text-decoration:none;}a{  text-decoration: none;}.link2{color:#ffffff;border-top:10px solid #27A1E5;border-bottom:10px solid #27A1E5;border-left:18px solid #27A1E5;border-right:18px solid #27A1E5;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background:#27A1E5;}.link3{color:#555555;border:1px solid #cccccc;padding:10px 18px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background:#ffffff;}.link4{color:#27A1E5;line-height: 24px;}h2,h1{line-height: 20px;}p{  font-size: 14px;  line-height: 21px;  color:#AAAAAA;}.contentEditable li{}.appart p{}.bgItem{background: #ffffff;}.bgBody{background: #ffffff;}img {  outline:none;  text-decoration:none;  -ms-interpolation-mode: bicubic;  width: auto;  max-width: 100%;  clear: both;  display: block;  float: none;} 
    </style> 
            ...
            <td> 
              <div class="contentEditableContainer contentImageEditable"> 
                <div class="contentEditable" style="text-align: center;"> 
                  <img src="https://i.ibb.co/TMZGH5D/banner.jpg" alt="Logo" width="580px" /> 
                </div> 
              </div> 
            </td> 
          </tr> 
                ...
                <tr> 
                  <td> 
                    <div class="contentEditableContainer contentTextEditable"> 
                      <div class="contentEditable" style="text-align: center">
                          <p style="color:#263238;" >Estimado(a) @nombrePersona,</p> 
                          <br /> 
                          <p style="color:#263238;">Se encuntra admitido(a) a la Red Formación de Formadores de la Escuela Judicial Rodrigo Lara Bonilla, le damos la bienvenida como Formador</p>
						  <p style="color:#263238;">Nombre del Curso: @nombreCurso. Nombre del módulo:@nombreModulo.</p>
                          <br /> 
                          <p style="color:#263238;" >Reciba in cordial saludo,<</p> 
                          <p style="color:#263238;" >>Equipo Comunidad Educativa EJRLB<</p> 
                          <br /> 
                          <br /> 
                          <a href="http://www.ejrlb.net" class="link3" style="color:#555555;">EJRLB</a> 
                    </div> 
                  </td> 
                </tr> 
                <tr> 
            ...
            <td width="400" align="center" style="text-align: center;"> 
              <table width="400" cellpadding="0" cellspacing="0" align="center"> 
                <tr> 
                  <td> 
                    <div class="contentEditableContainer contentTextEditable"> 
                      <div class="contentEditable" style="text-align: center;color:#AAAAAA;"></div> 
                    </div> 
                  </td> 
                </tr> 
              </table> 
