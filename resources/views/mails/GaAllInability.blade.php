...
<body>
    ...
    <?php
        $inability = array_filter($ChInability, fn($element) => $element['ch_record_id'] == $in);
    ?>


    <!-- Encabezado-->
    <div>
        @foreach($inability as $ch)
        <div>
 ...
 <div> 
    ...
    @if((count($hcAll)-1) != array_search($in, $hcAll)) 
    ...
    <div style="width: 100%">
        ...
        @if($firm != null)
            ...
            <p style="margin-top:8.95pt; margin-left:14pt; margin-right:14pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
                <span style="font-family:Calibri; font-weight:bold; color:#000000; background-color:#ffffff">{{$ch[0]['user']['firstname']}} {{$ch[0]['user']['middlefirstname']}} {{$ch[0]['user']['lastname']}}  {{$ch[0]['user']['middlelastname']}}</span>
                <span style="width:171.33pt; display:inline-block; -aw-tabstop-align:left; -aw-tabstop-pos:257.05pt">&#xa0;</span>
            </p>
            <p style="margin-top:8.95pt; margin-left:14pt; margin-right:14pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
                <span style="font-family:Calibri; font-weight:bold; color:#000000; background-color:#ffffff">{{$ch[0]['user']['user_role'][0]['role']['name']}}</span>
                <span style="width:171.33pt; display:inline-block; -aw-tabstop-align:left; -aw-tabstop-pos:257.05pt">&#xa0;</span>
            </p>
            @if(count($ch[0]['user']['assistance']) > 0)
            <p style="margin-top:8.95pt; margin-left:14pt; margin-right:14pt; margin-bottom:0pt; widows:0; orphans:0; font-size:10pt">
                <span style="font-family:Calibri; font-weight:bold; color:#000000; background-color:#ffffff">RM/TP: {{$ch[0]['user']['assistance'][0]['medical_record']}}</span>
                <span style="width:171.33pt; display:inline-block; -aw-tabstop-align:left; -aw-tabstop-pos:257.05pt">&#xa0;</span>
            </p>            
        @endisset   
    </div>
