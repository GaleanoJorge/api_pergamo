                ...
                <tr> 
                  <td> 
                    <div class="contentEditableContainer contentTextEditable"> 
                      <div class="contentEditable" style="text-align: center">
                          <p style="color:#263238;" >Estimado(a) @coordinador,</p> 
                          <br /> 
                          <p style="color:#263238;">El envío de correros programados no se realizo con éxito para las siguientes personas: @personasCorreoNoEnviado.</p>
                          <br /> 
                          <br /> 
                          <br /> 
