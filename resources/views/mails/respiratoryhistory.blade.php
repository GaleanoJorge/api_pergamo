...
<div>
    ...
    <div>
        ...
        <!-- Validación Regular -->
        <div>
            @if(count($ChRespiratoryTherapyEvo) > 0 || count($ChBackground) > 0 || count($ChGynecologists) > 0 || count($ChVitalSignsEvo) > 0  || count($ChOxygenTherapyEvo) > 0 || count($ChRtSessionsEvo) > 0 )
