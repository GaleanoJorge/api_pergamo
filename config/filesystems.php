...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'files_delivery' => [
            'driver' => 'local',
            'root'   => storage_path('app/public/delivery'),
        ],

        'certificates_templates' => [
            'driver' => 'local',
            'root'   => storage_path('app/public/certificates_templates'),
        ],
        ...
        'certificates_signatures' => [
            'driver' => 'local',
            'root'   => storage_path('app/public/certificates_signatures'),
        ],

        'files_sync_tmp' => [
            'driver' => 'local',
            'root'   => storage_path('app/files_sync_tmp'),
        ],

        'logs_sync' => [
            'driver' => 'local',
            'root'   => storage_path('app/logs_sync'),
        ],
