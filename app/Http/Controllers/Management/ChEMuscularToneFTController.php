        ...
        $ChEMuscularToneFT = ChEMuscularToneFT::where('ch_record_id', $id)->where('type_record_id',$type_record_id)
            ...
            if ($request->has_input) { //
                if ($request->has_input == 'true') { //
                    ...
                    $ChEMuscularToneFT = ChEMuscularToneFT::select('ch_e_muscular_tone_f_t.*')
                        ->where('ch_record.admissions_id', $chrecord->admissions_id) //
                        ->where('ch_e_muscular_tone_f_t.type_record_id', 1)
                        ->leftJoin('ch_record', 'ch_record.id', 'ch_e_muscular_tone_f_t.ch_record_id') //
