        ...
        if ($request->search) {
            $ChAssSigns->where(function ($query) use ($request) {
                $query->where('fluter', 'like', '%' . $request->search . '%')
                    ...
                    ->orWhere('periorbitary', 'like', '%' . $request->search . '%')
                    ->orWhere('none', 'like', '%' . $request->search . '%')
                    ->orWhere('intercostal', 'like', '%' . $request->search . '%')
                    ->orWhere('aupraclavicular', 'like', '%' . $request->search . '%');
            });
        }
