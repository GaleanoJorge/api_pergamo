...
class CategoriesOriginController extends Controller
{
    ...
    public function indexArray(Request $request): JsonResponse
    {
        if ($request->origin_id) {
            ...
            $categories = Category::select(
                ...
                'categoriesOrigin.planned_budget',
                'categoriesOrigin.allocated_budget',
                'categoriesOrigin.executed_budget',
                'category.name'
            )
    ...
    {
        $categories = CategoriesOrigin::select(
            'program.name AS program',
            'category.name AS subprogram',
            'category.id AS subprogram_id',
            'categories_origin.allocated_budget',
