...
class ManagementPlanController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        } else if ($request->ch_record_id) {
            $ManagementPlan = ManagementPlan::select('management_plan.*')
                ...
                ->where('ch_record.id', $request->ch_record_id)
                ->with(
                    'type_of_attention',
                    'service_briefcase',
                    'service_briefcase.manual_price',
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if($request->type_of_attention_id != 20 && !$request->procedure_id && (!$request->type_auth || $request->isnewrequest && $request->isnewrequest == 1)){
            return response()->json([
                'status' => false,
