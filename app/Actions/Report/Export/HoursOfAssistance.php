...
class HoursOfAssistance
{
    ...
    public static function handle(object $filters): array
    {
        $sql = "SELECT
                    ...
                    DATE_FORMAT(resumen_asistencia.fecha,'%Y-%m-%d') AS 'FECHA SESIÓN',
                    resumen_asistencia.cantidad_entradas AS 'ENTRADAS SESIÓN',
                ...
                INNER JOIN (
                    ...
                    GROUP BY course.id, asistencia.user_role_group_id, sesion.session_date
        ...
        if (@$filters->identification) {
            $sql .= " AND discente.identification = '" . $filters->identification . "'";
        }
