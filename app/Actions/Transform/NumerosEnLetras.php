...
namespace App\Actions\Transform;
...

{
    ...
    public static function convertir($number, $currency = '', $format = false, $decimals = '', $uppercase = false)

    {
        ...
        return strtolower($valor_convertido);
    }
