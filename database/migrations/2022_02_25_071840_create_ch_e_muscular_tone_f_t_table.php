...
class CreateChEMuscularToneFTTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ch_e_muscular_tone_f_t', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ch_e_muscular_tone_f_t');
    }
}
