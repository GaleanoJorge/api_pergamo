...
class CreateChRNTherapeuticObjOTTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ch_r_n_therapeutic_obj_o_t', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ch_r_n_therapeutic_obj_o_t');
    }
}
