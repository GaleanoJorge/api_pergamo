...
class CreateChESysMusculoskeletalFTTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ch_e_sys_musculoskeletal_f_t', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ch_e_sys_musculoskeletal_f_t');
    }
}
